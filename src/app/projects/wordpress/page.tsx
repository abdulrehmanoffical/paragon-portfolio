...
export const metadata: Metadata = {
  ...
  description: "Websites designed to be clear, practical, responsive, and easy to manage.",
};

export default function WordPressPage() {
  const service = SERVICES_INFO["wordpress"];
  const projects = getProjectsByService("wordpress");
